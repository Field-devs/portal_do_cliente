...
export default function ProposalForm({ onClose }: ProposalFormProps) {
  ...
  const classSelect = "mt-1 text-center block w-full rounded-md border-gray-300 shadow-sm focus:border-brand focus:ring-brand dark:bg-gray-700 dark:border-gray-600 dark:text-white font-bold";
            ...
            <div>
              <div className="space-y-4">
                ...
                <div style={{ marginBottom: '50px' }}>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    O Contrato foi Criado, enviado o link para o email do CLIENTE.
                  </label>
                </div>
                ...
                <div className="bg-brand/5 dark:bg-brand/10 rounded-xl p-4">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center">
                      <DollarSign className="h-6 w-6 text-brand dark:text-brand-400 mr-2" />
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-sm text-gray-500 dark:text-gray-400">por mês</span>
                    </div>
                  </div>
                </div>
              </div>
